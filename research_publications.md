...
19. <span style="display:inline-block;width:18px;height:18px;background-color:#6398b0;border-radius:3px;vertical-align:middle;margin-right:4px;"></span>  **Luo, X.**, Hu, Y.\*, Liu, H.\*, & Liu, Y. (In press). Enhancing two-stage estimation in differential equation models: A bias correction method via stochastic approximation. ***Psychometrika***. \[IF: 3.1/3.4, Q1\]
...
6. <span style="display:inline-block;width:18px;height:18px;background-color:#6398b0;border-radius:3px;vertical-align:middle;margin-right:4px;"></span>  **Luo, X.**, Gao, Y., & Liu, H.\* (2026, Jul, Beijing, China). Comparative benchmarking of mixed-effects machine learning and large language models on real-time depression forecasting. In *the 2026 Meeting of International Society for Data Science and Analytics*.
